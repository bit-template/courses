...
| --------- | ------------- | ------------------------------- | -------- | -------- | -------- | ----------- | ------------ | ----------------------- | --------------------------------------------------------------------------- | ------------------------------- |
| course-001   | Documentation           | Technical Paper Writing | HiTech/Mahasree K.I                | Intermediate    | 1 Hour | Mandatory  |  None  |  All Contributors       |  Learn about how to write a technical research paper and approach a standard journal.        | [connect](https://github.com/bit-template/courses/blob/feature/resources/Journal_Publishing_Presentation.pdf) |
| course-002   | Programming Language           | Basic Python | Hitech/Ganesh                |  Beginner   | 3 Hours | Mandatory  | None   |  All Contributors       |  Learn about basics of python language.        | None |
